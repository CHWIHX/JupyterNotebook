...
## 2.0.13
  ...
  - Web Extension updates:
    - Now Supporting image edit capability using Vscode extensions for Image editing (supported file extensions are png, jpg, webp, bmp, tga, ico, dib, jif, jpe, tpic, jpe, jpeg) [#733](https://github.com/microsoft/powerplatform-vscode/issues/733)
    - File explorer now supports Power Pages actions for "Going back to Power pages Studio" and "Preview" of site's runtime instance. [#697](https://github.com/microsoft/powerplatform-vscode/issues/697)
    - On browser refresh, Improved support for pre-emptive loading of image files active in editor. [#736](https://github.com/microsoft/powerplatform-vscode/issues/736)
...
## 1.0.21
  - hotfix in pac CLI `pac paportal *` for [#255](https://github.com/microsoft/powerplatform-vscode/issues/255)
